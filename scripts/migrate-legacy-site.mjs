...
.date-switch select{width:128px;max-width:100%;font:inherit;font-size:11px;color:var(--ink);background:#071008;border:1px solid var(--dim);padding:5px 24px 5px 9px;outline:none;cursor:pointer;color-scheme:dark}
